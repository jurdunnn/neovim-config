...
let s:darkgray    = { "gui": "#585858", "cterm": "240" }
let s:lightgray   = { "gui": "#dadada", "cterm": "253" }
let s:darkblue    = { "gui": "#005faf", "cterm": "25"  }
...
call s:h("Normal", s:fg, s:bg, "Bold")

call s:h("Cursor", s:bg, s:blue, "")
call s:h("CursorColumn", "", s:cursor_line, "")
call s:h("CursorLine", "", s:cursor_line, "")

call s:h("LineNr", s:darkgray, s:gutter_bg, "")
...
call s:h("IncSearch", s:bg, s:selection, "")
call s:h("Search", s:fg, s:selection, "")
